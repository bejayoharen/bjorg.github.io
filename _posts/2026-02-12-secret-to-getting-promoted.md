...
[^smallco]: Some small companies may not have a written policy, and there might be disagreement about what the right policy should be. In this case, do your best to figure out how things are going to work before going through steps to try and get promoted.

[^notevery]: My experience is mostly in tech startups. I'm sure other workplaces, like universities, governments and other large organizations, are different, putting more emphasis on credentials for example.
