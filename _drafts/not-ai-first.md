...
excerpt: AI is already a powerful tool, with tons of potential on the way, but being "AI-First" is not the right way to make use of it.
header:
...
In 2025, a lot of companies announced they are going "AI-First". Not everyone is in favor of this. Duolingo, for example, came under a lot of fire for [their announcement](https://www.linkedin.com/posts/duolingo_below-is-an-all-hands-email-from-our-activity-7322560534824865792-l9vh/#). Most of the backlash they received came from people accusing them of replacing contractors and human nuance with AI.[^duo] That's a worthwhile conversation, but I'm here to consider something else: why the "AI-first" mindset is bad for business.

AI-First means a company culture where everyone tries using AI to solve every task before trying to solve the problem via other means.[^def] I've got a few problems with the idea of jumping first to AI _everything_.[^luddite]
...
In a task like this, AI is not deeply considering the information you have, and isn't helping you understand why one strategy might make more sense than another. AI is just giving you an answer that looks nice. The AI-first result is a document that makes it look like you did the assignment, when you actually did not. You might even fool yourself into thinking AI did a good job.

# AI lacks context

AI is not just a problem for high-level documents. Paul Graham argues that ["writing is thinking"](https://paulgraham.com/writes.html), so when you outsource your writing to AI, you outsource your thinking. AI doesn't have the context it needs to do a good job, and even if it did, we shouldn't let someone else do the thinking for us.
...
Even for menial tasks like summarizing or formatting, I've seen lots of problems caused by using AI. When it summarizes a thread or writes a ticket, it doesn't have the full context without which AI is more prone to make mistakes. The more important the task, usually the more context is needed and the less AI is able to do a good job.
...
AI works best when creating boiler plate and filling in details, but planning organizing is still a challenge. I haven't seen good success with AI taking over larger projects or doing any sort of work that can't be solved by the developer themselves.

Maybe someday, AI will be better at solving problems you can't solve yourself, but for now, if you _can_ solve the problem yourself, AI _is_ good at taking away some of the menial bits of the job. For now, if you _can't_ do it yourself you won't be able to do it with AI, either.
...
A recent study[^mit] by MIT agreed: "AI has already won the war for simple work, 70% prefer AI for drafting emails, 65% for basic analysis. But for anything complex or long-term, humans dominate by 9-to-1 margins."

# What I am doing instead

So how am I using AI, and how am I adopting it as an engineering leader? I love AI as a tutor, asking it to help me think through a problem and asking it questions about things I don't understand. It's really nice to be able to ask AI without having to nudge a colleague out of their flow state. Sometimes it's challenging to poke AI's brain because of how reluctant it is to disagree, but when prodded the right way it can be very helpful.

As for encouraging AI use at the company level, I prioritize is making sure everyone is familiar with the tools, but I don't track AI output, and I don't treat all AI usage as good.[^leaderboard] Experimentation is what matters now and for that to work everyone must have the tools, formal and informal learning opportunities and so on. Everyone I work with is trying it for something and talking about what works and what doesn't. Beyond that, I trust my team to use AI where it makes sense -- and not for every task.
...
AI works best when you can understand and break the problem down yourself, then assign the parts that require mediocre thinking to AI. If, instead, you are using AI first for everything, you can expect to do a lot of reworking of sub-par results.
