...
excerpt: Using the right style of leadership at the right time means understanding how each style gives your team autonomy and clarity.
header:
...
_Size indicates amount of context required (larger is more), Color indicates the amount of coordination the problem requires (red is more). This chart is obviously a bit hand-wavy, but I think it can be helpful to visualize which approaches are suited to which problems._

# Leadership by autonomy

### What it is
There are as many leadership styles as there are leaders, but many of the most talked about styles can be grouped under "leadership by autonomy" because they all emphasize giving goals and then trusting teams to figure out how to achieve them. That is, they function by trusting in teams and individuals to carry out work autonomously.
...
Instead of giving autonomy, some leaders choose to focus much of their time involving themselves deeply in day-to-day work of the team. Some people call this "[founder mode](https://paulgraham.com/foundermode.html)", although I'm not sure that term has a clearly agreed-upon definition.
...
I also think it's important that as you remain involved, you never give the impression of taking over. This style reduces autonomy, and that only works if people have confidence in you and feel like your involvement is at least collaborative. This also allows you to operate with your team without understanding each and every tiny detail.
...
If you don't know the details well, this kind of leadership can be the worst -- you don't want to be that micromanaging boss who doesn't know what's going on. Using this style when you are new to a company or a project is generally a disaster.
...
Leading with policy works best for decisions that are repeated, such as hiring process, and making small technical or product decisions. As a company grows there are more and more of those kinds of decisions, so it becomes more and more helpful to have well-written policies.
...
Sometimes a problem requires more than just a decision -- it requires top-down coordination and top-down strategy. This is where leadership by conviction comes in. When leading by conviction, you need to make a decision (or set of decisions) and get everyone to buy into it.
...
I like to use consensus when working with a single team, because I want everyone motivated and fully bought in. I also like to use it any time a decision can't be made by one person alone, because no one person understands all the details.

### Pitfalls

Leadership by consensus can run into trouble when there are genuine disagreements, or people aren't willing to honestly speak up about their concerns. This can lead to suboptimal decisions that not everyone agrees with. Despite the claim of achieving consensus, it can really just create the kind of compromise that everyone is unhappy with.
